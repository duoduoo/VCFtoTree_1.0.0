...
#Function to make sure program is operating in VCFtoTree_1.0.0 folder
global path
...
def confPage():
    ...
    try:
        ...
        #print 'in confpage function, path is:'
        #os.system('pwd')
    ...
    os.system('Code/buildTree_1click_erica.sh %s %s %s %s' % (
    outputValues[0], outputValues[1], outputValues[2], speciesList2))
